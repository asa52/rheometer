  1621 , 1623 , 1624 , 1626 , 1628 , 1630 , 1633 , 1636 , 1639 , 1642 , 1645 , 1648 , 1651 , 1654 , 1657 , 1660 , 1663 , 1666 , 1669 , 1672 , 1675 , 1678 , 1681 , 1684 , 1687 , 1690 , 1693 , 1697 , 1700 , 1703 , 1707 , 1710 , 1712 , 1713 , 1715 , 1717 , 1718 , 1720 , 1722 , 1723 , 1725 , 1727 , 1728 , 1730 , 1733 , 1735 , 1738 , 1741 , 1744 , 1746 , 1749 , 1752 , 1755 , 1757 , 1760 , 1763 , 1765 , 1768 , 1770 , 1773 , 1775 , 1778 , 1780 , 1783 , 1785 , 1788 , 1790 , 1792 , 1794 , 1797 , 1799 , 1801 , 1803 , 1806 , 1808 , 1810 , 1812 , 1814 , 1817 , 1819 ,
  1821 , 1823 , 1826 , 1828 , 1830 , 1832 , 1835 , 1837 , 1839 , 1841 , 1844 , 1846 , 1848 , 1850 , 1853 , 1855 , 1857 , 1860 , 1862 , 1864 , 1866 , 1869 , 1871 , 1873 , 1875 , 1878 , 1880 , 1883 , 1886 , 1889 , 1892 , 1895 , 1898 , 1901 , 1904 , 1906 , 1909 , 1912 , 1915 , 1918 , 1921 , 1924 , 1927 , 1930 , 1934 , 1937 , 1941 , 1945 , 1948 , 1952 , 1955 , 1959 , 1963 , 1966 , 1970 , 1973 , 1975 , 1978 , 1980 , 1983 , 1986 , 1988 , 1991 , 1993 , 1996 , 1999 , 2001 , 2004 , 2007 , 2009 , 2012 , 2014 , 2017 , 2020 , 2022 , 2025 , 2027 , 2030 , 2033 , 2036 ,
...
void TC0_Handler(){
    ...
    if(1 == centre_mode){used_zero_A0 = equilibrium_A0;}
    else{used_zero_A0 = centre;}
    
    if(1 != NR && (0 == run_option || 1 == run_option) ){                        
    func = ( ( (waveformsTable[t] - waveformsTable[0]) * amp) / 2048 ) + 2047;
    }
    else if(1 != NR && 2 == run_option){func = DC_func;}
...
void handle_const_strain_feedback(){
     ...
     if( (pos <= 1558 || pos >= 3633) && amp >= 1){      
      ...
      if( 1 == freq_check ){
        if( (pos + 16) >= pos_rec && (pos - 16) <= pos_rec){//points are sparse, 
          // so a strict recurrence condition can miss many cycles
          if( 175000 <= val ){//at freq < 2Hz shorter periods are presumably the 2Hz fundamental
           if( 6 < t_diff ){ 
            if( 0 == (f_count % 2) && 1 < f_count 
             && 15 > ( t_diff + rec_times[f_count] ) ){f_count -=2;}
          ...
          t_diff = 0;
            ...
            if( 6 < t_diff ){
             if( 0 == (f_count % 2) && 1 <= f_count 
              && 60 > ( t_diff + rec_times[f_count] ) ){f_count -=2;}
            else if( 0 == (f_count % 2) ){//2nd recurrence of a value implies completed period
               A0_period_estimates[A0_period_count] = t_diff + rec_times[f_count];
               pest_check = (120 - A0_period_estimates[A0_period_count]);
               pest_num = A0_period_count;
            ...
            t_diff = 0;
               ...
               if( 16 == A0_period_count ){A0_period_count = 0;}
          }
    ...
    switch(p){
    case 0 :send_3_byte_value(amp, 0b00000000);break;
    case 3 :send_3_byte_value(sym_check, 0b00000001);break;
    case 5 :send_3_byte_value(centre, 0b00000010);break;
    case 7 :send_3_byte_value(peak_to_peak, 0b00000100);break;
    case 9 :send_3_byte_value(A0_period_estimates[A0_period_count], 0b00001000);break;
    case 11 :if( 0 > phase_estimates[delta_num] ){
             send_3_byte_value(phase_estimates[delta_num], 0b00010001);
           }
             else {send_3_byte_value(phase_estimates[delta_num], 0b00010000);}
             //centre_estimated = 0;
             break;
    case 125 :send_3_byte_value(amp, 0b00000000);break;
    case 129 :send_3_byte_value(A0_period_estimates[A0_period_count], 0b00001000);break;
    case 131 :if( 0 > phase_estimates[delta_num] ){
             send_3_byte_value(phase_estimates[delta_num], 0b00010001);
           }
             else {send_3_byte_value(phase_estimates[delta_num], 0b00010000);}
             break;
    case 245 :send_3_byte_value(amp, 0b00000000);break;
    case 249 :send_3_byte_value(A0_period_estimates[A0_period_count], 0b00001000);break;
    case 251 :if( 0 > phase_estimates[delta_num] ){
             send_3_byte_value(phase_estimates[delta_num], 0b00010001);
           }
             else {send_3_byte_value(phase_estimates[delta_num], 0b00010000);}
             break;
    case 365 :send_3_byte_value(amp, 0b00000000);break;
    case 369 :send_3_byte_value(A0_period_estimates[A0_period_count], 0b00001000);break;
    case 371 :if( 0 > phase_estimates[delta_num] ){
             send_3_byte_value(phase_estimates[delta_num], 0b00010001);
           }
             else {send_3_byte_value(phase_estimates[delta_num], 0b00010000);}
             centre_estimated = 0;
    ...
    if(last_t > t){dt = t + (120-last_t);}
     ...
     darraydt[p] = dmudt;  
      ...
      if( (p % sample_num) == 1){// reset estimates every full cycle, for p == 1, 121, 241 and 361
         ...
         if( -60 > phase_estimates[delta_num] ){phase_estimates[delta_num] = sample_num + phase_estimates[delta_num];}
         else if( 60 < phase_estimates[delta_num] ){phase_estimates[delta_num] = sample_num - phase_estimates[delta_num];}
         delta_num ++;
         }
       ...
       if (16 == delta_num){delta_num = 0;}
         ...
         if (8 == e_num){e_num = 0;}
           ...
           if( array[p] > array[p-1]){ //start making new extremum estimates
                peak = array[p]; trough = array[p-1];
                t_peak = t;      t_trough = last_t;}
           if( array[p] < array[p-1]){
                peak = array[p-1]; trough = array[p];
                t_peak = last_t;      t_trough = t;}
           
           if( darraydt[p] > darraydt[p-1]){     
                dpeakdt = darraydt[p]; dtroughdt = darraydt[p-1];
                t_dpeakdt = t;      t_dtroughdt = last_t;}
           if( darraydt[p] < darraydt[p-1]){
                dpeakdt = array[p-1]; dtroughdt = darraydt[p];
                t_dpeakdt = last_t;      t_dtroughdt = t;}
           
           
       }
       else if( 1 < p && (p % sample_num) != 1){ //else compare values within cycle
           if( peak < array[p]){peak = array[p]; t_peak = t;}
           if( trough > array[p]){trough = array[p]; t_trough = t;}
           if( dpeakdt < darraydt[p]){dpeakdt = darraydt[p]; t_dpeakdt = t;}
           if( dtroughdt > darraydt[p]){dtroughdt = darraydt[p]; t_dtroughdt = t;}
    ...
    if(0 == run_option){
           ...
           if(0 == strain_closing_in ){adaptive_step_calculation_for_const_strain();}
           else if(1 == strain_closing_in ){settle_amp();}
           ...
           else if( ( ( (peaksnt[feed_num][0] - troughsnt[feed_num][0]) /2) >= set_strain + mu_tol ) && 0 <= (amp - amp_step) ){
              amp -= amp_step;
              old_amp_step = amp_step;
             }
          }
...
//( (waveformsTable[t] * 512 * amp) / 1048576 )
    ...
    if( 0 != old_amp_step && 1 <= feed_num ){
      ...
      if( 64 < old_amp_step && 96 > old_amp_step){fiddle = 2;}
      else if( 96 < old_amp_step){fiddle = 1;}
      signed int step_estimate;
      
      step_estimate =( ( fiddle * old_amp_step * ( 
                     ( 2 * set_strain )
      ...
      if(8 >= amp && 8 < step_estimate){amp_step = 8;}                             
       
      if(0 > step_estimate){
       if(0 < step_count && 0 < past_step_estimates[step_count - 1]){sign_change_count ++;}
        
      step_estimate = (-step_estimate);
    
     } 
      else if(0 < step_count && 0 > past_step_estimates[step_count - 1]){sign_change_count ++;}      
      ...
      if( ( ( ( (peaksnt[feed_num][0] - troughsnt[feed_num][0]) /2) <= set_strain - mu_tol ) && 2048 > amp )
       || ( ( ( (peaksnt[feed_num][0] - troughsnt[feed_num][0]) /2) >= set_strain + mu_tol ) && 0 < amp ) ){ amp_step = 1; }
    ...
    if(8 == step_count){
      ...
      int d_step_dev = 0; 
      for(int i = 0; i < step_count;i++){
        if(mean_amp_step >= past_amp_steps[i]){d_step_dev += (mean_amp_step - past_amp_steps[i]);}
        else if(mean_amp_step < past_amp_steps[i]){d_step_dev += (past_amp_steps[i] - mean_amp_step);}
      }
...
void settle_amp(){
 ...
 if(0 == mean_tried){
  ...
  if( set_strain < ( 2 * set_strain - (peaksnt[feed_num][0] - troughsnt[feed_num][0]) )
   || (-1)*set_strain > ( 2 * set_strain - (peaksnt[feed_num][0] - troughsnt[feed_num][0]) ) ){strain_closing_in = 0;}
 
 amp_step = 1;
 /*
 if(3 >= sign_change_count){
 
 if(  ( ( (peaksnt[feed_num][0] - troughsnt[feed_num][0]) /2) < set_strain ) ){sign = -1;}
  
  
  if(32 >= amp_step_deviation && 4 > attempt_count){step_attempt = (amp_step_deviation/4);} 
  else if(16 >= amp_step_deviation && 4 > attempt_count){step_attempt = 4;}
  else{step_attempt = 2;}
       
  if(0 < attempt_count){
    if( (0 < past_attempts[attempt_count] && 0 > past_attempts[attempt_count - 1] )
     || (0 > past_attempts[attempt_count] && 0 < past_attempts[attempt_count - 1] ) ){sign_change_count ++;}
  }  
...
void map_centre_back_to_pos(int last_pos, int try_num, int twos){
  if( 10 > try_num && A0mu[last_pos] != centre){
    ...
    for(int j = 1; j < 128; j++){//only widen value search range once entry range has been searched
     ...
     if( A0mu[i] == centre + j ){pos_rec = (pos_0 + i); get_out = 1;break;}//break out i-loop
     else if( A0mu[i] == centre - j ){pos_rec = (pos_0 + i); get_out = 1;break;} 
     }
